...
class SArticleList extends StatefulWidget {
  const SArticleList({Key? key}) : super(key: key);

  @override
  _SArticleListState createState() => _SArticleListState();
}

class _SArticleListState extends State<SArticleList> {
  late final Future<List<ArticleModel>> _ArticleList;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    _ArticleList = ArticleApi.GetSportsArticleData();
  }
